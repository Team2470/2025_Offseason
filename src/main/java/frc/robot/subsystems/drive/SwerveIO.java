...
public interface SwerveIO extends SubsystemDataProcessor.IODataRefresher {
    ...
    default void updateSwerveInputs(SwerveIOInputsAutoLogged swerveInputs) {}
    ...
    void updateModuleInputs(ModuleIOInputsAutoLogged frontLeftInputs, ModuleIOInputsAutoLogged frontRightInputs,
