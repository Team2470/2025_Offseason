...
public class AutoChooser extends SendableChooser<Auto> {
    ...
    private static final List<AutoProgram> AUTO_PROGRAMS = List.of(
        new AutoProgram(Auto.LIKL, "LIKL", AutoFactory::createLIKLAuto),
        new AutoProgram(Auto.RFDC, "RFDC", AutoFactory::createRFDCAuto),
        new AutoProgram(Auto.MG2N, "MG2N", AutoFactory::createMG2NAuto));
    ...
    public void initSendable(SendableBuilder builder) {
        ...
        builder.publishConstString("selected", "%s".formatted(Auto.LIKL));
    }
